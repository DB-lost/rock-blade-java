...
public class ExportTaskController {
    ...
    public ExportTask startExport(@RequestBody @Parameter(description = "导出参数") Map<String, Object> params) {
    ...
    public ResponseEntity<Resource> downloadExport(@PathVariable @Parameter(description = "任务ID") String taskId) {
