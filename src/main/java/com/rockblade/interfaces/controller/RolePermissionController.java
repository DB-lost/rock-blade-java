...
public class RolePermissionController {
    ...
    public boolean save(@RequestBody @Parameter(description="角色和菜单关联表")RolePermission rolePermission) {
    ...
    public boolean update(@RequestBody @Parameter(description="角色和菜单关联表主键")RolePermission rolePermission) {
