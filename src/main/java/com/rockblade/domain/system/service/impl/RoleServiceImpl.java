...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    public Page<RoleResponse> getRoleList(RolePageRequest request) {
        ...
        return this.mapper.paginateWithRelationsAs(Page.of(pageDomain.getPage(), pageDomain.getPageSize()),
                queryChain().select(ROLE.ALL_COLUMNS).and(ROLE.ROLE_NAME.eq(request.getRoleName()))
                ...
                RoleResponse.class,
                permissions -> permissions.field(RoleResponse::getPermissions)
                        .queryWrapper(roleResponse -> QueryWrapper.create()
