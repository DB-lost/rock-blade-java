 ...
 * @LastEditTime: 2025-06-24 13:31:26
 * @FilePath: /rock-blade-java/rock-blade-framework/src/main/java/com/rockblade/framework/monitor/DatabaseMonitor.java
 * @Description: 数据库监控服务 用于收集PostgreSQL数据库性能指标、慢查询统计等
 *
